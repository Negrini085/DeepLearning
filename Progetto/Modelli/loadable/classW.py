...
if __name__ == "__main__":
    ...
    all_labels = []
    for images, labels in trDat.unbatch():
    ...
    histo = model.fit( trDat, validation_data=valDat, epochs=100, callbacks=[earlyS], class_weight=class_weights)
    ...
    df.to_csv("Modelli/training/try1W_histo.csv", index=False)

    model.save("Modelli/try1W.keras")
