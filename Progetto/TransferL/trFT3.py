...
if __name__ == "__main__":
    ...
    # Mantiengo congelati il 40% dei layer
    fine_tune_at = int(len(bMod.layers) * 0.4)
    ...
    histo = model.fit( trDat, validation_data=valDat, epochs=100, callbacks=[earlyS, reduceLR])
    ...
    df.to_csv("train/FT3_histo.csv", index=False)

    model.save("mod/FT3.keras")
